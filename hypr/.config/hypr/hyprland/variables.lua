terminal = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'foot' 'alacritty' 'kitty -1' 'wezterm' 'konsole' 'kgx' 'uxterm' 'xterm'"
...
codeEditor = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'windsurf' 'code' 'codium' 'antigravity' 'cursor' 'zed' 'zedit' 'zeditor' 'kate' 'gnome-text-editor' 'emacs' 'command -v nvim && kitty -1 nvim' 'command -v micro && kitty -1 micro'"
